...
def prepare_agentkit():
    ...
    # Clean and ensure private key is valid
    ...
    try:
        ...
        raise RuntimeError(
            f"Invalid Ethereum PRIVATE_KEY provided: {e}. "
            "Ensure PRIVATE_KEY in .env is a hex string starting with 0x and 64 hex characters."
        )
